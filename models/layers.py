...
class UNet2D(nn.Module):
    ...
    def __init__(self, in_channels: int=2,
                 ...
                 use_se_attention: bool=False) -> None:
        super().__init__()
...
class DiT3D(nn.Module):
    def __init__(self, input_size: Union[int, Tuple[int, int, int]]=32,
                 patch_size: int=2,
                 in_channels: int=4,
...
class DiT2D(nn.Module):
    def __init__(self, input_size: Union[int, Tuple[int, int]]=32,
                 patch_size: int=2,
                 in_channels: int=4,
                 hidden_size: int=1152,
                 depth: int=28,
...
class LatentDiT3D(nn.Module):
    ...
    def bottleneck(self, x: torch.Tensor,
                   t: torch.Tensor) -> torch.Tensor:
        out = self.dit(x, t)
